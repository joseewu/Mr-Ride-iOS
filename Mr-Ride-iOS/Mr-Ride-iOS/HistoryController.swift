...
class HistoryController: UIViewController, UITableViewDelegate, UITableViewDataSource ,NSFetchedResultsControllerDelegate{
    ...
    func setChart(dataPoints:[String], values:[Double]){
        ...
        let gradColors = [UIColor.mrLightblueColor().CGColor, UIColor.mrWaterBlueColor().CGColor]
        
        let colorLocate:[CGFloat] = [0.0, 0.19]
        let gradient = CGGradientCreateWithColors(CGColorSpaceCreateDeviceRGB(), gradColors, colorLocate)
        ...
        lineChartDataSet.fillColor = UIColor.mrWaterBlueColor()
