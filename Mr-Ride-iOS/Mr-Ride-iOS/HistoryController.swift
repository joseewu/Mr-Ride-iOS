...
class HistoryController: UIViewController, UITableViewDelegate, UITableViewDataSource ,NSFetchedResultsControllerDelegate{
    ...
    override func viewDidLoad() {
        ...
        //        print(fetchedResultController.fetchedObjects?[0])
        //print(fetchedResultController.indexPathForObject(1)?.valueForKey("date"))
    ...
    func setChart(dataPoints:[String], values:[Double]){
        ...
        if dataPoints.count < 0 {
            let dataEntry  = ChartDataEntry(value: 0, xIndex: 0)
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell{
        ...
        cell.lableTimes.text = String(runRecord.timeString) as String ?? "0.0"
