...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func logUser() {
        ...
        Crashlytics.sharedInstance().setUserEmail("jean0129123@gmail.com")
        Crashlytics.sharedInstance().setUserIdentifier("888888")
        Crashlytics.sharedInstance().setUserName("Root")
    }
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "josee.Mr_Ride_iOS" in the application's documents Application Support directory.
